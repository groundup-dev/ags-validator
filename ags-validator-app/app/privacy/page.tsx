    ...
    <div className="flex flex-col gap-10 mx-auto py-10 px-4">
      ...
      <section className="mt-8">
        ...
        <ul className="list-disc ml-5 mt-2">
          <li>
            ...
            process personal information based on your interaction with our
            Services. Learn more about personal information you disclose to us.
          </li>
          <li>
          ...
          <li>
            ...
            communicate with you, ensure security, and comply with the law.
          </li>
          <li>
            <strong>
      ...
      <section className="mt-8">
        ...
        <p>
          ...
          express interest in obtaining information about us, our products, or
        ...
        <p>
          ...
          accurate, and you must notify us of any changes.
        </p>
        ...
        <p>
          In Short: We automatically collect certain information when you use
          our Services.
        </p>
        <p>
          This includes information such as your IP address, browser and device
          characteristics, and other technical details necessary for maintaining
      ...
      <section className="mt-8">
        ...
        <p>
          ...
          Services, communicate with you, ensure security, and comply with legal
          obligations.
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <p>
          ...
          reason to do so, such as your consent, compliance with laws, contract
          fulfillment, and other legitimate business interests.
        </p>
        <p>
          If you are in the EU or UK, we rely on GDPR-compliant bases. If you
          are in Canada, we rely on express or implied consent under Canadian
          privacy law.
        </p>
      </section>
      <section id="when-and-with-whom-do-we-share-your-information">
        <h2 className="text-xl font-semibold">
      ...
      <section id="contact-about-notice">
        <h2 className="text-xl font-semibold">
          9. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?
        </h2>
        <p>
          If you have questions or comments about this notice, you may email us
          at james@groundup.cloud or contact us by post at:
        </p>
        <address>
          GROUNDUP SYSTEMS LTD
          <br />
          124 - 128 City Road
          <br />
          London EC1V 2NX
      ...
      <section id="review-update-delete-data">
        ...
        <p>
          ...
          delete your personal information, please visit: james@groundup.cloud.
        </p>
      </section>
    </div>
  );
